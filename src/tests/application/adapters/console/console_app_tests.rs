use crate::{application::adapters::console::console_app::{ConsoleApp, TConsoleApp}, domain::services::poems_service::TPoemsService, infrastructure::persistence::file_system::poems_in_file_system::TPoemsInFileSystem, tests::mock::{mock_logger::MockLogger, mock_poem::mock_poem, mock_poems_loader::MockPoemsLoader}};
